package com.loizenai.springboot.pagination.mongodb;
...
import com.loizenai.springboot.pagination.mongodb.repository.CustomerRepository;

@SpringBootApplication
public class SpringBootPaginationMongoDbApplication implements CommandLineRunner{

	@Autowired
	CustomerRepository customerRepository;
	
	public static void main(String[] args) {
		SpringApplication.run(SpringBootPaginationMongoDbApplication.class, args);
	}
